...
| **053** | File-size exception register — extends ADR-032's documented-exception precedent to the 12 other files over the 800-line guide (dated 2026-07-17 line counts + per-file cohesion rationale + split trigger), after a 2026-07-01 mechanical-split attempt (ARP-7) caused regressions and was reverted; `docs/CODING_STANDARDS.md` now points here instead of silently tolerating the gap | Accepted | [ADR-053](ADR-053-file-size-exception-register.md) |
