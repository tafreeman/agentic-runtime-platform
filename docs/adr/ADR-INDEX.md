...
> **Total ADRs:** 34 (27 Accepted, 5 Proposed, 2 Superseded)
...
| **038** | Live discovery for LM Studio (`/v1/models`) and ONNX (`genai_config.json`) local models | Accepted | [ADR-038](ADR-038-lmstudio-onnx-discovery.md) |
