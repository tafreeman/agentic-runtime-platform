...
# ─────────────────────────────────────────────────────────────────────────────
# Duplicated string constants (extracted to satisfy DRY / SonarQube S1192)
# ─────────────────────────────────────────────────────────────────────────────

LIMIT_PER_ACCOUNT = "per account"
NOTE_FREE_TIER = "free tier applies"
NOTE_REASONING_FREE_TIER = "reasoning; free tier applies"
NOTE_PREVIEW_LIMITS = "preview; limits not published"
CAP_RESEARCH_WEB = "research/web-grounded"
NOTE_AIGALLERY_GPU = "aigallery catalog — GPU variant, needs download"
...
REGISTRY: dict[str, ProviderEntry] = {
    ...
    "github_models": {
        ...
        "models": [
            ...
            },
            {
                ...
                "capability": "chat",
                "status": "working",
                "rate_limit": {"note": NOTE_FREE_TIER},
            },
            {
            ...
            },
            {
                ...
                "capability": "chat",
                "status": "working",
                "rate_limit": {"note": NOTE_REASONING_FREE_TIER},
            },
            {
                "id": "openai/o1-mini",
                "capability": "chat",
    ...
    "gemini": {
        ...
        "models": [
            ...
            },
            {
                ...
                "capability": "chat",
                "status": "working",
                "rate_limit": {"note": NOTE_PREVIEW_LIMITS},
            },
            {
    ...
    "nvidia_nim": {
        ...
        "models": [
            # ── Flagship chat ──────────────────────────────────────────────────
            {
                ...
                "rate_limit": {
                    "rpm": 40,
                    "note": "per account; 2 accounts = 80 RPM combined",
                },
            },
            {
                ...
                "capability": "chat",
                "status": "working",
                "rate_limit": {"rpm": 40, "note": LIMIT_PER_ACCOUNT},
            },
            {
    ...
    "ollama": {
        ...
        "models": [
            ...
            {
                "id": "hf.co/lmstudio-community/Qwen3.6-27B-GGUF:Q8_0",
                "capability": "chat",
                "status": "working",
                "note": "29.5 GB Q8_0",
            },
            {
                "id": "hf.co/lmstudio-community/Qwen3.6-27B-GGUF:Q4_K_M",
                "capability": "chat",
                "status": "working",
                "note": "17.5 GB Q4_K_M",
            },
    ...
    "lm_studio": {
        ...
        "models": [
            # ── Chat / reasoning ──────────────────────────────────────────────
            {
                "id": "qwen/qwen3.5-35b-a3b-uncensored",
                "capability": "chat",
                "status": "working",
...
def models_by_capability(capability: str) -> list[dict]:
    """Return flat list of {provider, base_url, auth_env, model_id, rate_limit}
    dicts."""
    out = []
    for provider, info in REGISTRY.items():
        for m in info.get("models", []):
            if m.get("capability") == capability and m.get("status") in (
                "working",
                "trial",
            ):
                out.append(
