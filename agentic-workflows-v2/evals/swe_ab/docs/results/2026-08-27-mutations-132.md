...
[Kit](../../README.md) · [Docs](../README.md) — **result**, point-in-time; never rewritten · conclusion superseded by [the SWE-bench run](2026-08-28-swebench-35.md) · running tally: [EVIDENCE.md §1](../EVIDENCE.md#1-results-chronological)

Supersedes the 50-case run in `2026-08-27-mutations-50.md`. Same question, a case set
