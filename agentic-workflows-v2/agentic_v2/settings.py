...
class Settings(BaseSettings):
    ...
    agentic_sanitize_agent_loop: bool = Field(
        ...
        description=(
            ...
            "just the HTTP request boundary. Also governs secret masking of "
            "each LangGraph step's final response "
            "(agentic_v2.langchain.response_sanitization), whose agents never "
            "call that client. DEFAULT ON. Skipped automatically "
