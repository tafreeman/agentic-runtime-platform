...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn("border-y border-el-divider bg-el-surface [&_tr]:border-b", className)}
      {...props}
    />
  )
}
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-el-divider-soft transition-colors hover:bg-el-subtle data-[state=selected]:bg-el-subtle",
        className
      )}
      {...props}
    />
